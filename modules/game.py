...
def draw_objects():
    ...
    while True:
        ...
        if (ball.ycor() <= -310 and ball.xcor() < player1.xcor() - 48.75 and
                ball.xcor() >= player1.xcor() - 65 and
                ball.ycor() > -322):
            ball.dx = -1
            ball.dy *= -1
            pong_sound()
        elif (ball.ycor() <= -310 and ball.xcor() > player1.xcor() + 48.75 and
                ball.xcor() <= player1.xcor() + 65 and
                ball.ycor() > -322):
            ball.dx = 1
            ball.dy *= -1
            pong_sound()
        elif (ball.ycor() <= -310 and ball.xcor() < player1.xcor() - 32.5 and
            ...
            ball.dy *= -1
            pong_sound()
        elif (ball.ycor() <= -310 and ball.xcor() < player1.xcor() - 16.25 and
            ...
            ball.dy *= -1
            pong_sound()
        elif (ball.ycor() <= -310 and ball.xcor() < player1.xcor() and
